...
const Logo = ({ color = 'white', size = 'normal', hideText = false }: LogoProps) => (
  <S.Wrapper color={color} size={size} hideText={hideText}>
    ...
    >
      ...
      />
      <ellipse fill='#0A0D27' rx='1.51' ry='1.5' transform='matrix(1 0 0 1 44.72 13.66)' />
      <ellipse fill='#0A0D27' rx='1.51' ry='1.5' transform='matrix(1 0 0 1 49.74 17.6)' />
      <ellipse fill='#0A0D27' rx='1.51' ry='1.5' transform='matrix(1 0 0 1 44.72 21.6)' />
      <ellipse fill='#0A0D27' rx='1.51' ry='1.5' transform='matrix(1 0 0 1 39.7 17.6)' />
      <path
        className='text'
        fill='currentColor'
